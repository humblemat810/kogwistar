...
chroma_client = Client(
    Settings(
        ...
        or "./chroma_db",  # "./chroma_db", "doc_chroma"
        anonymized_telemetry=False,
    )
)


node_collection = chroma_client.get_or_create_collection("nodes")
edge_collection = chroma_client.get_or_create_collection("edges")
