...
def _build_task_set_from_runner_getter(
    *, get_runner_for_task, provider_hints: LLMTaskProviderHints
    ...
    def _adjudicate_pair(
        ...
        from kogwistar.engine_core.models import LLMMergeAdjudication
    ...
    def _adjudicate_batch(
        ...
        from kogwistar.engine_core.models import BatchAdjudications
    ...
    def _filter_candidates(
        ...
        from kogwistar.conversation.models import FilteringResponse
