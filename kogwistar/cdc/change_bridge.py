...
python -m kogwistar.cdc.change_bridge --host 127.0.0.1 --port 8787

Reset oplog on launch:

python -m kogwistar.cdc.change_bridge --reset-oplog

Custom oplog path + fsync:

python -m kogwistar.cdc.change_bridge --oplog-file .cdc_debug/data/my_oplog.jsonl --fsync

python -m kogwistar.cdc.change_bridge --host 127.0.0.1 --port 8787 --oplog-file .cdc_debug/data/cdc_oplog.jsonl --reset-oplog
"""
if __name__ == "__main__":
    import sys
...
# uvicorn kogwistar.cdc.change_bridge:app --host 127.0.0.1 --port 8787 --log-level info --access-log
