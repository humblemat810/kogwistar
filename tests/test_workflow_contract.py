...
def test_cycle_allowed_but_exit_required():
    nodes = [
        _FakeNode("A", {"entity_type": "workflow_node", "workflow_id": "wf", "wf_op": "x", "wf_start": True}),
        _FakeNode("B", {"entity_type": "workflow_node", "workflow_id": "wf", "wf_op": "y"}),
    ]
    edges = [
        _FakeEdge("e1", "A", "B", {"entity_type": "workflow_edge", "workflow_id": "wf", "wf_is_default": True}),
        _FakeEdge("e2", "B", "A", {"entity_type": "workflow_edge", "workflow_id": "wf", "wf_is_default": True}),
    ]
...
def test_terminal_satisfies_exit():
    nodes = [
        _FakeNode("A", {"entity_type": "workflow_node", "workflow_id": "wf", "wf_op": "x", "wf_start": True}),
        _FakeNode("B", {"entity_type": "workflow_node", "workflow_id": "wf", "wf_op": "y", "wf_terminal": True}),
    ]
    edges = [
        _FakeEdge("e1", "A", "B", {"entity_type": "workflow_edge", "workflow_id": "wf", "wf_is_default": True}),
    ]
