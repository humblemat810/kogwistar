...
def scenario_summary_snapshot(
    *, backend_kind: str, tmp_path, sa_engine, pg_schema, monkeypatch
) -> tuple[Any, str]:
...
def scenario_answer_flow_snapshots(
    *, backend_kind: str, tmp_path, sa_engine, pg_schema, monkeypatch
) -> tuple[Any, str]:
    kg, conv = _make_engine_pair(
        backend_kind=backend_kind,
...
def scenario_backbone_only(
    *, mode: str, backend_kind: str, tmp_path, sa_engine, pg_schema, monkeypatch
) -> tuple[Any, str]:
    kg, conv = _make_engine_pair(
        backend_kind=backend_kind,
        tmp_path=tmp_path,
