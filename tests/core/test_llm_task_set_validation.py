...
def _valid_task_set() -> LLMTaskSet:
    return LLMTaskSet(
        extract_graph=lambda _req: ExtractGraphTaskResult(raw=None, parsed_payload=None, parsing_error=None),
        adjudicate_pair=lambda _req: AdjudicatePairTaskResult(verdict_payload=None, raw=None, parsing_error=None),
        ...
        answer_with_citations=lambda _req: AnswerWithCitationsTaskResult(answer_payload=None, raw=None, parsing_error=None),
        repair_citations=lambda _req: RepairCitationsTaskResult(answer_payload=None, raw=None, parsing_error=None),
    )
