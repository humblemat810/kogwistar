...
The Rust async authority intentionally remains fail-closed under worker
contract v1.  This gate proves that boundary plus the existing Python async
runtime parity; it does not treat a skipped or silently downgraded async path
as Rust authority.
"""
...
def run_gate(
    *,
    ...
    return {
        ...
        "async_rust_authority": "fail-closed-worker-contract-v1",
        "groups": reports,
