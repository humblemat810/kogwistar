...
class EngineLike(Protocol):
    ...
    @property
    def node_collection(self) -> CollectionLike: ...
    @property
    def edge_collection(self) -> CollectionLike: ...
    @property
    def edge_endpoints_collection(self) -> CollectionLike: ...
    @property
    def document_collection(self) -> CollectionLike: ...
    @property
    def node_docs_collection(self) -> CollectionLike: ...
