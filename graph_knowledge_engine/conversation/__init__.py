...
if TYPE_CHECKING:
    from graph_knowledge_engine.conversation.designer import (
    ...
    from graph_knowledge_engine.conversation.knowledge_retriever import (
        KnowledgeRetriever,
    )
    from graph_knowledge_engine.conversation.memory_retriever import MemoryRetriever
    from graph_knowledge_engine.conversation.retrieval_orchestrator import (
